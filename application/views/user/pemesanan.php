          ...
          <!-- Collapsable Card Example -->
            <div class="card shadow mb-6">
              ...
              <a class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                <center><h6 class="m-0 font-weight-bold text-primary">Data Pemesanan Lapangan</h6></center>
              </a>
			...
			<tbody> 
				...
				<tr>
					...
					<!-- <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahbukti"></a> -->
						<a href="javascript:;" data-id="<?php echo $t->id_bayar ?>"     
                            data-toggle="modal" data-target="#ubah-data"  class="btn btn-info">Upload Bukti Bayar
						</a>
						<br><br>
...
<div class="container">
      ...
      <div class="row text-center">
        <div class="col-md-4">
          ...
          <h4 class="service-heading">Willy Permana</h4>
