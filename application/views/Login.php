...
<body>
    <section style="height: 100%; width: 100%; box-sizing: border-box; background-color: #232130">
        <style>


        </style>
        <div class="d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif;">
            <div class="position-relative d-none d-lg-block h-100 width-left-content-3-10">
                <img class="position-absolute img-fluid centered-content-3-10" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content3/Content-3-11.png" alt="">
            </div>
            <div class="d-flex mx-auto align-items-left justify-content-left width-right-content-3-10">
                <div class="right-content-3-10">
                    ...
                    <h3 class="title-text-content-3-10">Silahkan Login di Bawah Ini</h3>
                    <?= $this->session->set_flashdata('error'); ?>
                    <p class="caption-text-content-3-10">Selamat Datang di Aplikasi Penyewaan Lapangan Futsal.</p>
                    <form id="sign_in" style="margin-top: 1.5rem;" action="<?= base_url(); ?>Login" method="POST">
                        <div style="margin-bottom: 1.75rem;">
                            <label for="" class="d-block input-label-content-3-10">Username</label>
                            <div class="d-flex w-100 div-input-content-3-10">
                                <svg class="icon-content-3-10" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input class="input-field-content-3-10" type="text" name="username" id="" placeholder="Your Username" required autofocus>
                            </div>
                        </div>
                        <div style="margin-top: 1rem;">
                            <label for="" class="d-block input-label-content-3-10">Password</label>
                            <div class="d-flex w-100 div-input-content-3-10">
                                <svg class="icon-content-3-10" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input class="input-field-content-3-10" type="password" name="password" id="" placeholder="Your Password" minlength="6" required>
                                <div>
                        ...
                        <!-- <div class="text-right" style="margin-top: 0.75rem;">
                            <a href="#" class="forgot-password-content-3-10 font-italic">Forgot Password?</a>
                        </div> -->
                        <button class="btn btn-fill-content-3-10 d-block w-100" type="submit">Log In To My Account</button>
                    </form>
                    <p class="text-center bottom-caption-content-3-10">Don't have an account yet?
                        <a href="<?= base_url() ?>Register" span class="green-bottom-caption-content-3-10">Register Here</a>
                    </p>
                </div>
            </div>
